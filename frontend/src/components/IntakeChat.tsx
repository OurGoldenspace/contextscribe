  ...
  export default function IntakeChat() {
    ...
    async function startIntake(): Promise<void> {
      ...
      try {
        ...
        const body =
          (await response.json()) as ApiResponse<IntakeSessionState>
        ...
        console.error('[intake/start] failed', requestError)
    ...
    async function sendMessage(
      ...
      try {
        ...
        console.error('[intake/message] failed', requestError)
      ...
      <main style={styles.page}>
        <section style={styles.container}>
          <header style={styles.header}>
            <div>
              <p style={styles.eyebrow}>ContextScribe</p>
              <h1 style={styles.title}>
                Pre-visit intake
              </h1>
              <p style={styles.subtitle}>
                Answer one question at a time. Your responses
                will be organized for clinician review.
              </p>
            </div>
            ...
            <section style={styles.summaryCard}>
              ...
              <div style={styles.summaryGrid}>
                ...
                <SummaryField
                  ...
                  value={formatList(summary.uncertain)}
                />
              </div>
              ...
              <button
                ...
                style={{
                  ...styles.primaryButton,
                  marginTop: '1.25rem',
                  opacity: isGeneratingSOAP ? 0.55 : 1
                }}
              >
                {isGeneratingSOAP
  ...
  function SOAPSection({
    ...
    return (
      <div style={styles.soapSection}>
        <h3 style={styles.soapTitle}>{title}</h3>
